...
const InputObject = Schema.StructWithRest(
  Schema.Struct({
    ...
    browser_open: Schema.optional(Action),
    browser_act: Schema.optional(Action),
    browser_observe: Schema.optional(Action),
    browser_extract: Schema.optional(Action),
    browser_screenshot: Schema.optional(Action),
    browser_state: Schema.optional(Action),
    browser_console: Schema.optional(Action),
    browser_network: Schema.optional(Action),
    browser_resize: Schema.optional(Action),
    browser_eval: Schema.optional(Action),
    browser_close: Schema.optional(Action),
